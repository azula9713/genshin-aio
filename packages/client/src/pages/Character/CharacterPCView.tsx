...
export default function CharacterPCView({
  ...
  return (
    <LazyBackgroundImg
      ...
      // img=""
      isDarkened
      className="hidden xl:flex w-[calc(100%-3rem)] flex-col relative items-start justify-between p-10 xl:min-h-[calc(125vh-16rem)] 2xl:min-h-[calc(105vh-16rem)] h-max m-4 rounded-lg"
    >
